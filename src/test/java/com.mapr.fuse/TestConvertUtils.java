...
public class TestConvertUtils {
    ...
    public void getTopicNameTest() {
        ...
        Assert.assertEquals("topic", ConvertUtils.getTopicName(path));
    }
    ...
    public void transformToTopicNameTest() {
        ...
        Assert.assertEquals("/stream:topic", topicName);
    }

    @Test
    public void getPartitionIdTest() {
        Path path = new File("/folder/stream/topic/21").toPath();
        Assert.assertEquals(21, ConvertUtils.getPartitionId(path));
    }
    ...
    public void getFullPathTest() {
        ...
        Assert.assertEquals("/mapr/cluster/folder3/stream/topic/0", fullPath.toString());
    }
